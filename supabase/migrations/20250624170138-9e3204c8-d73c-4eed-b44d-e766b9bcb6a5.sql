...
-- Step 1: Clean up duplicate triggers and implement proper flow separation
...
-- Step 2: Create function for auth.users - ONLY creates profiles when email is confirmed
...
-- Step 3: Create function for profiles - handles invitation processing
...
-- Step 4: Create the triggers with proper separation
