    ...
    <div className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-medium text-blue-900">Organization Team Setup</h3>
            <p className="text-sm text-blue-700 mt-1">
              Invite team members to your organization. This affects the entire organization and helps you build your complete staff roster.
            </p>
          </div>
        </div>
      </div>
          ...
          <Card key={member.id} className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
              ...
              <div className="md:col-span-3">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <div className="max-w-xs">
                            ...
                            <p className="text-sm mb-2">Full control over the organization, can manage all trials and team members</p>
                            <p className="font-medium">Staff:</p>
                            <p className="text-sm">Can participate in trials with specific permissions assigned per trial</p>
                          </div>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                ...
                <Select 
                  value={member.role} 
                  onValueChange={(value: 'admin' | 'staff') => updateMember(member.id, 'role', value)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
